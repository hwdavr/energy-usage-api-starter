...
TOKEN=$(curl -s -X POST http://localhost:8080/v1/auth/login \
  -H 'Content-Type: application/json' \
  -d '{"Email":"you@example.com","Password":"Passw0rd!"}' | jq -r .token)

3. Create a meter:

MID=$(curl -s -X POST http://localhost:8080/v1/meters \
  -H "Authorization: Bearer $TOKEN" \
  -H 'Content-Type: application/json' \
  -d '{"label":"Home Main Meter"}' | jq -r .id)

4. Add readings:

curl -s -X POST http://localhost:8080/v1/meters/$MID/readings \
  -H "Authorization: Bearer $TOKEN" \
  -H 'Content-Type: application/json' \
  -d '{"reading_kwh": 12.5, "reading_at":"2025-10-01T09:00:00Z"}' | jq .

curl -s -X POST http://localhost:8080/v1/meters/$MID/readings \
  -H "Authorization: Bearer $TOKEN" \
  -H 'Content-Type: application/json' \
  -d '{"reading_kwh": 3.0, "reading_at":"2025-10-03T09:00:00Z"}' | jq .
